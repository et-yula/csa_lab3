...
class ControlUnit:
    ...
    def execute_instruction(self, instr, data):
        if instr == "NOP": # NOP
            ...
            if data["F"] == 0: # LD 5
                self.data_path.signal_latch_ac(magic_numbers.MUX_L_0, magic_numbers.MUX_R_PR, {"op":"ADD", "PR": data["V"]}); self.tick()
            elif data["F"] == 1: # LD [5]
                self.data_path.signal_latch_ar(magic_numbers.MUX_L_0, magic_numbers.MUX_R_PR, {"op":"ADD", "PR": data["V"]}); self.tick(3)
                ...
                self.data_path.signal_latch_ar(magic_numbers.MUX_L_0, magic_numbers.MUX_R_PR, {"op":"ADD", "PR": data["V"]}); self.tick(4)
                self.data_path.signal_latch_ar(magic_numbers.MUX_L_AR, magic_numbers.MUX_R_SP, {"op":"ADD"})
                self.data_path.signal_oe()
                self.data_path.signal_latch_ac(magic_numbers.MUX_L_0, magic_numbers.MUX_R_DR, {"op":"ADD"})
            elif data["F"] == 3: # LD [[SP+5]]
                self.data_path.signal_latch_ar(magic_numbers.MUX_L_0, magic_numbers.MUX_R_PR, {"op":"ADD", "PR": data["V"]}); self.tick(6)
                self.data_path.signal_latch_ar(magic_numbers.MUX_L_AR, magic_numbers.MUX_R_SP, {"op":"ADD"})
                self.data_path.signal_oe()
            ...
            if data["F"] == 0: # ST 5
                self.data_path.signal_latch_ar(magic_numbers.MUX_L_0, magic_numbers.MUX_R_PR, {"op":"ADD", "PR": data["V"]}); self.tick(2)
                ...
                self.data_path.signal_latch_ar(magic_numbers.MUX_L_0, magic_numbers.MUX_R_PR, {"op":"ADD", "PR": data["V"]}); self.tick(5)
                self.data_path.signal_latch_ar(magic_numbers.MUX_L_AR, magic_numbers.MUX_R_SP, {"op":"ADD"})
                self.data_path.signal_oe()
                self.data_path.signal_latch_ar(magic_numbers.MUX_L_0, magic_numbers.MUX_R_DR, {"op":"ADD"})
                self.data_path.signal_wr(magic_numbers.MUX_L_AC, magic_numbers.MUX_R_0, {"op":"ADD"})
            ...
            if data["F"] == 0: # ADD 5
                self.data_path.signal_latch_ac(magic_numbers.MUX_L_AC, magic_numbers.MUX_R_PR, {"op":instr, "PR": data["V"], "set_flag": True}); self.tick()
            elif data["F"] == 1: # LD [5]
                self.data_path.signal_latch_ar(magic_numbers.MUX_L_0, magic_numbers.MUX_R_PR, {"op":"ADD", "PR": data["V"]}); self.tick(3)
                self.data_path.signal_oe()
                self.data_path.signal_latch_ac(magic_numbers.MUX_L_AC, magic_numbers.MUX_R_DR, {"op": instr, "set_flag": True})
            ...
            self.IP = self.data_path.alu(magic_numbers.MUX_L_0, magic_numbers.MUX_R_PR, {"op":"ADD", "PR": data["V"]}); self.tick()
        elif instr == "JE":
            self.tick()
            ...
            self.data_path.signal_latch_sp(magic_numbers.MUX_S_DEC);  self.tick(4)
            self.data_path.signal_latch_ar(magic_numbers.MUX_L_0, magic_numbers.MUX_R_SP, {"op":"ADD"})
            self.data_path.signal_wr(magic_numbers.MUX_L_0, magic_numbers.MUX_R_PR, {"op":"ADD", "PR": self.IP})
            self.IP = self.data_path.alu(magic_numbers.MUX_L_0, magic_numbers.MUX_R_PR, {"op":"ADD", "PR": data["V"]})
        elif instr == "RET":
            self.data_path.signal_latch_ar(magic_numbers.MUX_L_0, magic_numbers.MUX_R_SP, {"op":"ADD"}); self.tick(4)
            self.data_path.signal_oe()
            ...
            self.data_path.signal_latch_ac(None, None, None, magic_numbers.MUX_A_INP); self.tick(1)
        elif instr == "OUT":
